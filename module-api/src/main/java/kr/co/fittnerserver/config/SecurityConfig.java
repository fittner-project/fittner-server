    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/user/centers/**","/api/v1/user/common/status-chk", "/api/v1/auth/apple-redirect-url", "/api/v1/user/terms", "/api/v1/user/common/splash", "/api/v1/common/file/**", "/api/v1/user/common/app/version-chk", "/api/v1/user/center/list", "/api/v1/user/join", "/actuator/**", "/api/v1/auth/login", "/api/v1/auth/apple-info", "/api/v1/auth/refresh-token", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll().anyRequest().authenticated())
